...
$packageArgs = @{
   ...
   fileType         = 'EXE'
   url64bit         = 'https://github.com/standardnotes/app/releases/download/@standardnotes/desktop@3.181.4/standard-notes-3.181.4-win.exe'
   checksum64       = '1921d934ced4cadac662b4d6c8b2620839b50ccbec592051f0b7590830faaf78'
