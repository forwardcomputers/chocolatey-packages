...
$packageArgs = @{
   ...
   fileType         = 'EXE'
   url64bit         = 'https://github.com/standardnotes/app/releases/download/@standardnotes/desktop@3.186.0/standard-notes-3.186.0-win.exe'
   checksum64       = 'f04eebe2fe875094b0067c32f84fdd8fe10c0d3b6e2803f2c42ae3f1d8d0bbe4'
