...
$packageArgs = @{
   ...
   fileType         = 'EXE'
   url64bit         = 'https://github.com/standardnotes/app/releases/download/@standardnotes/desktop@3.187.1/standard-notes-3.187.1-win.exe'
   checksum64       = '211b986744bcd65a16ad509143b88d4cc5a3b02973ed6e6c4df9e7780356c2dc'
