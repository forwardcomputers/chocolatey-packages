...
$packageArgs = @{
   ...
   fileType         = 'EXE'
   url64bit         = 'https://github.com/standardnotes/app/releases/download/@standardnotes/desktop@3.183.43/standard-notes-3.183.43-win.exe'
   checksum64       = '1755537386377eb9540e5dd420a08ebabc9251f682a71b099a99dd1d7870982d'
