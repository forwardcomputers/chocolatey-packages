...
$packageArgs = @{
   ...
   fileType         = 'EXE'
   url64bit         = 'https://github.com/standardnotes/app/releases/download/@standardnotes/desktop@3.192.13/standard-notes-3.192.13-win.exe'
   checksum64       = '791ed11b47657f8e212d8bc79d13f19e521d1053b9d7eaecc80c1f1162a314da'
